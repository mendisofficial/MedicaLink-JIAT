...
@section('page-content')
    ...
    <input type="hidden" value="{{ $id }}" name="id" id="patientIdField">
    <!-- Search Section -->
    <div class="col-12">
        <div id="search-controls-section" class="mb-4 py-2 px-3 section-blur">
            ...
            <form action="" method="GET" class="mb-0">
                <div class="search-controls d-flex align-items-center">
                    ...
                    <input type="text" class="search-bar" name="query" placeholder="Search for medical records or vaccinations...">
                    <div class="vr mx-2"></div>
                        ...
                        <div class="col">
                            ...
                            <ul>
                                <li class="category">
                                    ...
                                    <label for="type1"># Vaccine Brand or Report Type</label>
                                </li>
    ...
    <div class="col">
        ...
        <div class="record-container px-4 py-3 section-blur shadow">
            ...
            <div class="record-data mt-4" id="record-data-container">
                ...
                <div class="d-flex align-items-center" id="result-titles">
                    <h5 class="mb-0">Vaccination Details</h5>
                    <div class="ms-auto d-flex align-items-center">
                        <span class="me-2 me-md-3 text-nowrap">Showing <span class="result-count">10</span> results</span>
                        <button class="add-btn" href="{{ route('admin.addPatientForm') }}">
                            <span class="me-2 d-none d-md-block">Add Vaccination</span>
                ...
                <div class="table-container mt-4 py-2 mx-md-4">
                    <table class="table mb-0" id="dataTableBody">
                        <thead>
                            <tr>
...
@section('scripts')
    ...
    <script src="{{ asset('js/admin/profileReport.js') }}"></script>
@endsection
