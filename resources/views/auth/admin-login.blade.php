...
@section('content')
    ...
    <section id="main" class="py-0">
        ...
        <div id="login-container" class="container-fluid">
            ...
            <form class="section-blur" method="POST" action="{{ route('admin.login') }}" id="login-form">

                @csrf
                <div class="logo">
                    <img src="{{ asset('images/logo-main.png') }}" alt="logo">
                    <p class="text-center mt-4 mb-md-1 fw-medium">Login to your admin account to continue....</p>
                </div>
                ...
                <div class="username input">
                    ...
                    <input type="text" id="usernameInput" placeholder="Email" name="email" autofocus>
                </div>
